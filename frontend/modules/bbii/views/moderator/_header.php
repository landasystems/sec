...
<div id="bbii-header">
    <?php if (!Yii::app()->user->isGuest): ?>
        ...
        <div class="bbii-profile-box">
            ...
            if ($this->isModerator())
                echo ' | ' . CHtml::link(CHtml::image($this->module->getRegisteredImage('moderator.png'), Yii::t('BbiiModule.bbii', 'Moderate'), array('title' => Yii::t('BbiiModule.bbii', 'Moderate'), 'style' => 'vertical-align:bottom;')), array('moderator/approval'));
            if ($this->isAdmin())
                echo ' | ' . CHtml::link(CHtml::image($this->module->getRegisteredImage('config.png'), Yii::t('BbiiModule.bbii', 'Forum settings'), array('title' => Yii::t('BbiiModule.bbii', 'Forum settings'), 'style' => 'vertical-align:bottom;')), array('setting/index'));
