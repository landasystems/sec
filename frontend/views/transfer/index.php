...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
		array('label'=>'Transfer', 'icon'=>'icon-plus', 'url'=>Yii::app()->controller->createUrl('create'), 'linkOptions'=>array()),
                array('label'=>'History Transfer', 'icon'=>'icon-th-list', 'url'=>Yii::app()->controller->createUrl('index'),'active'=>true, 'linkOptions'=>array()),
