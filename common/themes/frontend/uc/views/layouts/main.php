...
//                                'action' => $this->createUrl('user/anggota'),
                ...
                return false;" name="subscribe" value="Cek Data" class="orange" />
                        ...
                        <div class="form-wrapper" id="form-daftar" style="display:block">
                            ...
                            <input type="hidden" name="BbiiMember[username]" placeholder="Nama" id="username" />
                            <input type="hidden" name="BbiiMember[code]" placeholder="Nama" id="code" />
                            <input type="hidden" name="province_id" placeholder="Nama" id="code" value="5" />

                            <table width="100%">
                                <tr>
                                    <td>
                                        <input type="text" name="BbiiMember[member_name]" placeholder="Nama" id="name" readonly />
                                    </td>
                                    <td>
