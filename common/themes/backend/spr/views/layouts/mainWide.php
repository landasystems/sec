        ...
        <div id="wrapper">
            ...
            <div id="sidebar" style="margin-left: -299px; left: 0px;">
                <?php if (user()->isSuperUser) { ?>
                    <div class="shortcuts">
                        <ul>
                            <li><a href="<?php echo url('user/auditUser') ?>" title="History Login"><span class="icon24 entypo-icon-history"></span></a></li>
                            <li><a href="<?php echo url('/landa/help') ?>" title="Help"><span class="icon24 icomoon-icon-help-2"></span></a></li>
                            <li><a href="<?php echo url('/landa/fileManager') ?>" title="File Manager"><span class="icon24 icomoon-icon-folder-2"></span></a></li>
                            <li><a href="<?php echo url('/landa/help/aboutUs') ?>" title="About"><span class="icon24 eco-info"></span></a></li>
                        </ul>
                    </div><!-- End search -->            
                <?php } ?>
                <div class="sidenav">
