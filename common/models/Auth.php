...
//                array('visible' => landa()->checkAccess('User', 'r'), 'label' => '<span class="icon16 icomoon-icon-user-3"></span>User', 'url' => array('/user'), 'auth_id' => 'User'),
                array('visible' => landa()->checkAccess('User', 'r'), 'label' => '<span class="icon16  entypo-icon-contact"></span>User', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        array('visible' => landa()->checkAccess('User', 'r'), 'label' => '<span class="icon16 entypo-icon-users"></span>User', 'url' => url('/user'), 'auth_id' => 'GroupContact'),
                        array('visible' => landa()->checkAccess('Article', 'r'), 'label' => '<span class="icon16 iconic-icon-article"></span>Member', 'url' => array('/bbiiMember'), 'auth_id' => 'User'),
                        array('visible' => landa()->checkAccess('Article', 'r'), 'label' => '<span class="icon16 iconic-icon-article"></span>List Anggota', 'url' => array('/userSawiran'), 'auth_id' => 'User'),
                    )),
                ...
                array('visible' => landa()->checkAccess('Article', 'r'), 'label' => '<span class="icon16 iconic-icon-book-alt2"></span>Forum Setting', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        array('visible' => landa()->checkAccess('ArticleCategory', 'r'), 'label' => '<span class="icon16 eco-list"></span>Forum Layout', 'url' => array('/bbiiForum'), 'auth_id' => 'ArticleCategory'),
                        array('visible' => landa()->checkAccess('Article', 'r'), 'label' => '<span class="icon16 iconic-icon-article"></span>Kategori Usaha', 'url' => array('/businessCategory'), 'auth_id' => 'Article'),
//                        array('visible' => landa()->checkAccess('Article', 'r'), 'label' => '<span class="icon16 iconic-icon-article"></span>Approval', 'url' => array('/user/moderator'), 'auth_id' => 'User'),
//                        array('visible' => landa()->checkAccess('Article', 'r'), 'label' => '<span class="icon16 iconic-icon-article"></span>Report', 'url' => array('/user/moderator'), 'auth_id' => 'User'),
//                        array('visible' => landa()->checkAccess('Article', 'r'), 'label' => '<span class="icon16 iconic-icon-article"></span>Member', 'url' => array('/bbiiMember'), 'auth_id' => 'User'),
//                        array('visible' => landa()->checkAccess('Article', 'r'), 'label' => '<span class="icon16 iconic-icon-article"></span>List Anggota', 'url' => array('/userSawiran'), 'auth_id' => 'User'),
                    )),
                array('visible' => landa()->checkAccess('Article', 'r'), 'label' => '<span class="icon16 iconic-icon-book-alt2"></span>Post & Topic', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        array('visible' => landa()->checkAccess('ArticleCategory', 'r'), 'label' => '<span class="icon16 eco-list"></span>Post', 'url' => array('/bbiiPost'), 'auth_id' => 'ArticleCategory'),
                        array('visible' => landa()->checkAccess('ArticleCategory', 'r'), 'label' => '<span class="icon16 eco-list"></span>Topic', 'url' => array('/bbiiTopic'), 'auth_id' => 'ArticleCategory'),
//                        array('visible' => landa()->checkAccess('Article', 'r'), 'label' => '<span class="icon16 iconic-icon-article"></span>Approval', 'url' => array('/bbiiPost/approval'), 'auth_id' => 'Article'),
//                        array('visible' => landa()->checkAccess('Article', 'r'), 'label' => '<span class="icon16 iconic-icon-article"></span>Report', 'url' => array('/bbiiMessage/report'), 'auth_id' => 'User'),
                    )),
            ...
            return array(
                ...
                array('visible' => in_array('inventory', param('menu')), 'label' => '<span class="icon16 cut-icon-checkbox-checked"></span>Stock', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                ...
                array('visible' => in_array('inventory', param('menu')), 'label' => '<span class="icon16 cut-icon-cart"></span>Pembelian', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                ...
                array('visible' => in_array('inventory', param('menu')) || in_array('manufacture', param('menu')) && landa()->checkAccess('SellOrder', 'r'), 'label' => '<span class="icon16 silk-icon-calculator"></span>Penjualan', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                ...
                array('visible' => in_array('manufacture', param('menu')) && landa()->checkAccess('ProsesStatus', 'r'), 'label' => '<span class="icon16 silk-icon-notebook"></span>Produksi', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        ...
                        array('visible' => landa()->checkAccess('ProsesStatus', 'r'), 'label' => '<span class="icon16 entypo-icon-document"></span>Laporan Proses & Nota', 'url' => array('/workorder/takingNote'), 'auth_id' => 'ProsesStatus'),
                ...
                array('visible' => in_array('accounting', param('menu')) && (landa()->checkAccess('AccCoa', 'r') || landa()->checkAccess('AccJurnal', 'r') || landa()->checkAccess('BeginningBalance', 'r')), 'label' => '<span class="icon16 icomoon-icon-clipboard-2"></span>Accounting', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                    ...
                    array('visible' => landa()->checkAccess('AccJurnal', 'r'), 'label' => '<span class="icon16 iconic-icon-pen"></span>Jurnal', 'url' => array('/accJurnal'), 'auth_id' => 'AccJurnal'),
                        array('visible' => landa()->checkAccess('AccCoa', 'r'), 'label' => '<span class="icon16 silk-icon-checklist"></span>Saldo Awal', 'url' => array('/accCoa/beginningbalance'),),
                        array('visible' => landa()->checkAccess('AccCoa', 'r'), 'label' => '<span class="icon16 silk-icon-checklist"></span>Saldo Awal Kartu', 'url' => array('/accCoa/BalanceKartu'),),
                    )),
                array('visible' => in_array('accounting', param('menu')) && (landa()->checkAccess('AccCashIn', 'r') || landa()->checkAccess('AccCashOut', 'r')), 'label' => '<span class="icon16 icomoon-icon-clipboard-2"></span>Uang', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                ...
                array('label' => '<span class="icon16 cut-icon-printer-2"></span>Laporan', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        array('visible' => in_array('inventory', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Buy', 'url' => array('/report/buy'), 'auth_id' => 'Report_Buy'),
                        array('visible' => in_array('inventory', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Buy Retur', 'url' => array('/report/buyretur'), 'auth_id' => 'Report_BuyRetur'),
                        array('visible' => in_array('inventory', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Sell', 'url' => array('/report/sell'), 'auth_id' => 'Report_Sell'),
                        array('visible' => in_array('inventory', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Sell Retur', 'url' => array('/report/sellretur'), 'auth_id' => 'Report_SellRetur'),
                        array('visible' => in_array('inventory', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Stock Item', 'url' => array('/report/stockItem'), 'auth_id' => 'Report_StockItem'),
                ...
                array('label' => '<span class="icon16 wpzoom-settings"></span>Tools', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        array('visible' => in_array('accounting', param('menu'), landa()->checkAccess('Report_Neraca', 'r')), 'label' => '<span class="icon16 entypo-icon-book"></span>Auto Number', 'url' => array('dateConfig/index'), 'auth_id' => 'DateConfig'),
...
//                array('label' => '<span class="icon16 entypo-icon-add"></span>Additional Charge', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
//                        array('label' => '<span class="icon16 icomoon-icon-arrow-right"></span>Category', 'url' => array('/chargeAdditionalCategory')),
//                        array('label' => '<span class="icon16 icomoon-icon-arrow-right"></span>Item', 'url' => array('/chargeAdditional')),
//                    )),
                ...
                array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 icomoon-icon-clipboard-2"></span>Accounting', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        array('label' => '<span class="icon16 iconic-icon-pin"></span>Daftar Perkiraan', 'url' => array('/accCoa')),
                        array('label' => '<span class="icon16 iconic-icon-pen"></span>Jurnal', 'url' => array('/accJurnal')),
                    )),
                array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 icomoon-icon-clipboard-2"></span>Uang', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        array('label' => '<span class="icon16 iconic-icon-pen"></span>Masuk', 'url' => array('/accCashIn')),
                        array('label' => '<span class="icon16 iconic-icon-pen"></span>Keluar', 'url' => array('/accCashOut')),
                    )),
                ...
                array('visible' => landa()->checkAccess('RoomBill', 'r'), 'label' => '<span class="icon16 brocco-icon-wrench"></span>Tools', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        ...
                        array('visible' => landa()->checkAccess('RoomBill', 'r'), 'label' => '<span class="icon16 icomoon-icon-arrow-right"></span>Initial Forecast', 'url' => array('/initialForecast'), 'auth_id' => 'TaxExport'),
//                        array('label' => '<span class="icon16 entypo-icon-settings"></span>Setting Transaction', 'url' => array('chargeAdditionalCategory/settingTransaction')),
                ...
                array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 wpzoom-user-2"></span>Supplier', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        array('label' => '<span class="icon16 entypo-icon-users"></span>Group Supplier', 'url' => array('/landa/roles/supplier'), 'auth_id' => 'GroupSupplier'),
                        array('label' => '<span class="icon16  entypo-icon-user"></span>Supplier', 'url' => array('/user/supplier'), 'auth_id' => 'Supplier'),
                    )),
                array('visible' => landa()->checkAccess('Report_ProductSold', 'r'), 'label' => '<span class="icon16 cut-icon-printer-2"></span>View & Report', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        ...
                        array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Jurnal', 'url' => array('/report/jurnalUmum'), 'auth_id' => 'Report_Jurnal'),
                        array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Laporan Kas Harian', 'url' => array('/report/kasHarian'), 'auth_id' => 'Report_Kasharian'),
                        array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Buku Besar', 'url' => array('/report/generalLedger'), 'auth_id' => 'Report_Generalledger'),
                        array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Neraca Saldo', 'url' => array('/report/neracaSaldo'), 'auth_id' => 'Report_NeracaSaldo'),
                        array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Laba Rugi', 'url' => array('/report/labaRugi'), 'auth_id' => 'Report_LabaRugi'),
                        array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Neraca', 'url' => array('/report/neraca'), 'auth_id' => 'Report_Neraca'),
                        array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 cut-icon-printer-2"></span>Buku Pembantu', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                                array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Kartu Piutang', 'url' => array('/report/kartuPiutang'), 'auth_id' => 'Report_Piutang'),
                                array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Kartu Hutang', 'url' => array('/report/kartuHutang'), 'auth_id' => 'Report_Hutang'),
                                array('visible' => in_array('accounting', param('menu')), 'label' => '<span class="icon16 entypo-icon-book"></span>Kartu Stock', 'url' => array('/report/kartuStock'), 'auth_id' => 'Report_Stock'),
                            )),
                    )),
                array('label' => '<span class="icon16 icomoon-icon-bars"></span>Chart', 'url' => array('/User'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        array('label' => '<span class="icon16 icomoon-icon-arrow-right"></span>Income Statistic', 'url' => array('product/new'),),
                        array('label' => '<span class="icon16 icomoon-icon-arrow-right"></span>Room Statistic', 'url' => array('product/new'),),
                        array('label' => '<span class="icon16 icomoon-icon-arrow-right"></span>Grafik Penjualan', 'url' => array('product/new'),),
                    )),
            );
