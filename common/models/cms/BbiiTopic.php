...
//			'merge' => Yii::t('BbiiModule.bbii', 'Merge with topic'),
	...
	public function hasPostedClass() {
        ...
        public function getMemberName(){
            return $this->starter->member_name;
        }
        
        public function getLock(){
            if($this->locked == 0){
                $locked = '<span class="label label-important">No</span>';
            }else{
                $locked = '<span class="label label-info">Yes</span>';
            }
            return $locked;
        }
        ...
        public function getStick(){
            if($this->sticky == 0){
                $stick = '<span class="label label-important">No</span>';
            }else{
                $stick = '<span class="label label-info">Yes</span>';
            }
            return $stick;
        }
        
        public function getChangeGLobal(){
            if($this->global == 0){
                $global = '<span class="label label-important">No</span>';
            }else{
                $global = '<span class="label label-info">Yes</span>';
            }
            return $global;
        }
}