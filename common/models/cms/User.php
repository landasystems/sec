...
//    }
    ...
    public function rules() {
        ...
        return array(
            array('roles_id, password, city_id, business_id, phone, pin,type_business, company_name, address', 'required'),
            ...
            array('name, password, name,description, address, address2, pin, type_business, company_name', 'length', 'max' => 255),
...
//            array('email', 'email', 'on' => array('allow','register')),
            ...
            array('id, username, email,saldo, password, code, name, city_id, moderator, address, address2, business_id, pin, type_business, company_name, phone, created, created_user_id, modified,description', 'safe', 'on' => 'search'),
...
//            $criteria->together = true;
    ...
    public function relations() {
        ...
        return array(
            ...
            'BusinessCategory' => array(self::BELONGS_TO, 'BusinessCategory', 'business_id'),
