...
//
//        if (isset($_POST['Transfer']) && isset($_POST['Transfer']['to_user_id'])) {
...
//                    $others['saldo_prize'] -=$_POST['Transfer']['amount'];
//                } else {
//                    $others['saldo_prize'] = 0 - $_POST['Transfer']['amount'];
//                }
//                $user->others = json_encode($others);
//                $user->save();
//            }
//            if (isset($_POST['Transfer']['amount'])) {
//                $user = User::model()->findByPk($model->to_user_id);
//                $others = json_decode($user->others, true);
//                if (isset($others['saldo_prize'])) {
//                    $others['saldo_prize'] +=$_POST['Transfer']['amount'];
//                } else {
...
////            if (isset($_POST['Transfer']['amount'])) {
////                $user = User::model()->findByPk(Yii::app()->user->id);
////                $user->saldo -=$_POST['Transfer']['amount'];
////                $user->save();
////            }
////            if (isset($_POST['Transfer']['amount'])) {
////                $user = User::model()->findByPk($model->to_user_id);
