...
//    }
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['SiteConfig'])) {
            if(isset( $_POST['SiteConfig']['settings'])){
            $arrSettings = $_POST['SiteConfig']['settings'];
//            $roles = $_POST['SiteConfig']['settings']['mlm_action'];

//            if (isset($_POST['SiteConfig']['settings']['register_user_id']))
//                $arrSettings['register_user_id'] = $_POST['SiteConfig']['settings']['register_user_id'];
//
//            if (isset($_POST['SiteConfig']['settings']['register_is_generate_code']))
//                $arrSettings['register_is_generate_code'] = (isset($_POST['SiteConfig']['settings']['register_is_generate_code'])) ? $_POST['SiteConfig']['settings']['register_is_generate_code'] : 0;
//
//            if (isset($_POST['SiteConfig']['settings']['format']['user']))
//                $arrSettings['format']['user'] = $_POST['SiteConfig']['settings']['format']['user'];

//            if (isset($_POST['settings']['mlm_action_time'])) {
//                $mlm_action_time = array();
//                foreach ($_POST['settings']['mlm_action_time']['roles_id'] as $no => $key) {
//                    $mlm_action_time[$key] = $_POST['settings']['mlm_action_time']['value'][$no];
//                }
//                $arrSettings['mlm_action_time'] = $mlm_action_time;
//            }
            $model->settings = json_encode($arrSettings);
            }

//            $arrSettings['mlm_action'][$roles] = $_POST['SiteConfig']['settings']['mlm_action']['time'];

            $model->attributes = $_POST['SiteConfig'];
            
            if (!empty($_POST['SiteConfig']['roles_contact']))
                $model->roles_contact = json_encode($_POST['SiteConfig']['roles_contact']);
...
//                $this->redirect(array('view', 'id' => $model->id));
        ...
        if (!empty($model->roles_contact))
            $model->roles_contact = json_decode($model->roles_contact);
