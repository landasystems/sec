<?php
$this->setPageTitle('Edit Classrooms | ID : '. $model->id);
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
		array('label'=>'Tambah', 'icon'=>'icon-plus', 'url'=>Yii::app()->controller->createUrl('create'), 'linkOptions'=>array(),'visible'=>landa()->checkAccess('Classroom','c')),
                ...
                array('label'=>'Edit', 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id)),'active'=>true, 'linkOptions'=>array(),'visible'=>landa()->checkAccess('Classroom','u')),
	),
));
$this->endWidget();
?>
