<div class="form">
    ...
    <fieldset>
        ...
        <?php echo $form->errorSummary($model,'Opps!!!', null,array('class'=>'alert alert-error span12')); ?>
                    ...
                    <div class="controls">
        <?php echo CHtml::dropDownList('DownloadCategory[parent_id]', $model->parent_id, CHtml::listData(DownloadCategory::model()->findAll(array('order' => 'root, lft')), 'id', 'nestedname'), array('class' => 'span3', 'empty' => 'root')); ?>
                         </div>
                </div>
