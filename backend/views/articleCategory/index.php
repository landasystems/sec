<?php
$this->setPageTitle('Article Categories');
...
<?php
$buton="";
if(landa()->checkAccess('ArticleCategory', 'r')){
    $buton .= '{view}';
}
if(landa()->checkAccess('ArticleCategory', 'u')){
    $buton .= '{update}';
}
if(landa()->checkAccess('ArticleCategory', 'd')){
    $buton .= '{delete}';
}
