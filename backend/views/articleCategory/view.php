<?php
$this->setPageTitle('Lihat Article Categories | ID : '. $model->id);
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
		array('label'=>'Tambah', 'icon'=>'icon-plus', 'url'=>Yii::app()->controller->createUrl('create'), 'linkOptions'=>array(),'visible'=>landa()->checkAccess('ArticleCategory', 'c')),
                ...
                array('label'=>'Edit', 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id)), 'linkOptions'=>array(),'visible'=>landa()->checkAccess('ArticleCategory', 'u')),
